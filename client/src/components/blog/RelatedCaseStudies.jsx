...
export default function RelatedCaseStudies({ caseStudyIds }) {
  ...
  const caseStudiesMap = {
    ...
    "armx-indecodex": { title: "Armx-Indecodex Portal Refactor", desc: "Reducing layout shifts and loading speeds to achieve high Core Web Vitals." },
    traincape: { title: "Armx-Indecodex Portal Refactor", desc: "Reducing layout shifts and loading speeds to achieve high Core Web Vitals." }
};
