    ...
    <section className="py-20 md:py-24 bg-white relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
        <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 font-display">
          Ready to Deploy {productName || "Armx-Indecodex CRM"}?
        </h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          ...
          <a
            href={`https://wa.me/919911910793?text=${encodeURIComponent("Hi Armx-Indecodex Team, I would like to schedule a demo for the " + (productName || "enterprise CRM/SaaS") + " product and discuss hosting requirements.")}`}
            target="_blank"
